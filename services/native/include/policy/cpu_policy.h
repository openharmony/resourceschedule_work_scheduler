...
class CpuPolicy : public IPolicyFilter {
public:
    explicit CpuPolicy(std::shared_ptr<WorkPolicyManager> workPolicyManager);
    ~CpuPolicy() override;
    /**
...
#endif // FOUNDATION_RESOURCESCHEDULE_WORKSCHEDULER_CPU_POLICY_H