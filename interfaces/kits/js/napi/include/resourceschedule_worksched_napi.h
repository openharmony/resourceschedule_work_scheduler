 ...
 */
#ifndef FOUNDATION_RESOURCESCHEDULE_WORKSCHEDULER_NAPI_H
#define FOUNDATION_RESOURCESCHEDULE_WORKSCHEDULER_NAPI_H
 ...
 * Module define
 */
napi_module _resourcesched_work_sched_module = {
    .nm_version = 1,
    .nm_flags = 0,
    .nm_filename = nullptr,
